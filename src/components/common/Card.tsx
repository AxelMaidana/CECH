...
import { usePermissions } from '../auth/PermissionsProvider'; // Importamos el hook de permisos
  ...
  if (!userId){
    ...
    <div className="card relative rounded-3xl shadow-lg shadow-black/40 overflow-hidden transition-transform duration-300 group hover:scale-105 flex flex-col h-full">
      <h2 className="absolute top-40 text-3xl font-bold text-customBlack text-center z-10">
        Inicia sesión para ver este curso o contacta con el administrador
      </h2>
  ...
  return (
    <div className="group">
      {permissions.verCursos ? (
        ...
        <div className="card bg-gray-100 rounded-3xl shadow-lg shadow-black/40 overflow-hidden transition-transform duration-300 group hover:scale-105 flex flex-col h-full">
          <div className="relative w-full h-40 flex-shrink-0">
            {imageUrl && <img src="https://img.freepik.com/fotos-premium/signo-interrogacion-negro-sobre-fondo-negro-estudio_241146-2516.jpg" alt={title} className="w-full h-full object-cover " />}
            <div className="absolute inset-0 bg-gradient-to-b from-transparent to-white"></div>
          </div>

          <div className="bg-white p-6 flex flex-col flex-grow">
            <h2 className="mb-2 h-fit min-h-[72px] text-3xl font-bold text-customBlack line-clamp-2">No tienes permisos para ver este curso.</h2>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="bg-gray-200 w-full py-1 border-2 rounded-full animate-pulse"></span>
              <span className="bg-gray-200 w-full py-1 border-2 rounded-full animate-pulse"></span>
              <span className="bg-gray-200 w-full py-1 border-2 rounded-full animate-pulse"></span>
