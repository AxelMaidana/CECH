...
export default function Component({
  ...
  <div className="gap-y-6 grid grid-cols-1 md:grid-cols-2 justify-items-center items-center">
    {teachers.map((teacher, index) => (
      <div
        key={index}
        className="flex flex-col md:flex-row gap-x-6 p-6 w-fit bg-white rounded-lg relative group"
      >
        <div className="flex-shrink-0 justify-center mb-4 md:mb-0">
        ...
        <div className="flex flex-col space-y-4 w-full">
          <input
            ...
            className="w-full lg:w-64 px-3 py-2 text-sm rounded-xl border border-gray-200 bg-white placeholder:text-gray-400 focus:outline-none shadow-md shadow-black/30"
          />
          <textarea
    ...
    <button
      ...
      className="h-[200px] w-[320px] md:w-[337px] lg:w-[400px] flex items-center justify-center border-2 border-dashed border-gray-200 rounded-lg hover:border-[#008BB2] hover:bg-[#008BB2]/5 transition-colors group"
    >
