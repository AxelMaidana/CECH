          ...
          <form className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              <div className="flex justify-between items-center">
                ...
                <button
                    ...
                    className="mt-2 text-sm font-light underline text-blue-500 hover:text-blue-700"
                  >
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm  text-gray-500 px-4 py-2 outline-none"
